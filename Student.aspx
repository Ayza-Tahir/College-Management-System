<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="WebApplication2.Admin.Student" %>
        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <asp:TextBox ID="txtStudentName" runat="server" CssClass="form-control" placeholder="Enter Student Name" required></asp:TextBox>
                </div>
...
<div class="row mb-3 mr-lg-5 ml-lg-5">
    ...
    <div class="col-md-6">
        <label for="txtContactInfo">Contact_info:</label>
    ...
    <div class="col-md-6">
        <label for="txtEmail">Year ID</label>
        <asp:TextBox ID="txtYear" runat="server" CssClass="form-control" placeholder="Enter Year Name" required></asp:TextBox>
    </div>
</div>

            <div class="col-md-6">
        <label for="txtEmail">Roll no</label>
...
<div class="row mb-3 mr-lg-5 ml-lg-5">
    <div class="col-md-3 col-md-offset-2 mb-3">
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary btn-block"  BackColor="#5558C9" Text="Add Student" OnClick="btnAdd_Click" />
    </div>
</div>
    ...
    <div class="col-md-12">
        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                      ...
                      DataKeyNames="Student ID" OnPageIndexChanging="GridView1_PageIndexChanging"
        ...
        <ItemStyle HorizontalAlign="Center" />
                ...
                <asp:TemplateField HeaderText="Name">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtStudentNameEdit" runat="server" Text='<%# Eval("Student Name") %>' CssClass="form-control"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Roll Number">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtRollnoEdit" runat="server" Text='<%#Eval("Roll no") %>' CssClass="form-control"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="Year">
                    <ItemTemplate>
                        <asp:Label ID="lblYear" runat="server" Text='<%# Eval("Year ID") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtYearEdit" runat="server" Text='<%#Eval("Year ID") %>' CssClass="form-control"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Contact Info">
                    <ItemTemplate>
                        <asp:Label ID="lblContactInfo" runat="server" Text='<%# Eval("contact_info") %>'></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:TextBox ID="txtContactInfoEdit" runat="server" Text='<%# Eval("contact_info") %>' CssClass="form-control"></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
